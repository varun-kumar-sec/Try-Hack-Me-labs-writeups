...
Password: ```xWinter1995x!```
 ...
 3. Configuring the Spellchecker Exploit (TinyMCE RCE):
...
```
3. Compile and Fix Dependencies:
Modify the GCC call inside the C file (if required) and compile the binary:
```bash
